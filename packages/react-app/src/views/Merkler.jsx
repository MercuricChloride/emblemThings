...
function Merkler({
  ...
  useEffect(async () => {
    ...
    setRoot(tree.bufferToHex(root))
    console.log('is the current user in the tree?', tree.verify(proof, leaf, root))
    console.log('What about this dude?', tree.verify(tree.getProof(keccak256('0x000f9987b3352802ad6934402da1a215b1ecef13')), keccak256('0x000f9987b3352802ad6934402da1a215b1ecef13'), root)) // true
  }, []);
